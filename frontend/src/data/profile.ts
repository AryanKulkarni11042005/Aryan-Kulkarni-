...
/**
 * Bundled copy of the portfolio data. The same data is served by the
 * backend at GET /api/profile — see useProfile(), which prefers the API
 * and falls back to this snapshot so the site renders instantly and
 * works even when the API is unreachable.
 */
  ...
  projects: [
    {
      ...
      description:
        "A machine learning platform built with FastAPI, React, CatBoost, XGBoost, and economic datasets spanning 2011–2025. Enables forecasting, scenario simulation, and explainability.",
    ...
    },
    {
      ...
      metric: { value: "Claim → Evidence", label: "Validation pipeline" },
